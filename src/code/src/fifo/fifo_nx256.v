...
// Date: 2022-11-08
// Project: N/A
// Comments: FIFO Wrapper, variable depth, 256-bit wide
//
//********************************
// File history:
//   2022-11-08: Original
...
`ifdef USEIPFIFO
    ...
    generate case((DEPTH > MAX) ? MAX : DEPTH)
        ...
        16: begin
            ...
            fifo_16x256_xil fifo_16x256_xil (
                .rst        (!reset_),
        ...
        32: begin
            ...
            fifo_32x256_xil fifo_32x256_xil (
                .rst        (!reset_),
        ...
        64: begin
            ...
            fifo_64x256_xil fifo_64x256_xil (
                .rst        (!reset_),
        ...
        128: begin
            ...
            fifo_128x256_xil fifo_128x256_xil (
                .rst        (!reset_),
        ...
        256: begin
            ...
            fifo_256x256_xil fifo_256x256_xil (
                .rst        (!reset_),
        ...
        512: begin
            ...
            fifo_512x256_xil fifo_512x256_xil (
                .rst        (!reset_),
        ...
        1024: begin
            ...
            fifo_1024x256_xil fifo_1024x256_xil (
                .rst        (!reset_),
        ...
        2048: begin
            ...
            fifo_2kx256_xil fifo_2kx256_xil (
                .rst        (!reset_),
        ...
        4096: begin
            ...
            fifo_4kx256_xil fifo_4kx256_xil (
                .rst        (!reset_),
        ...
        8192: begin
            ...
            fifo_8kx256_xil fifo_8kx256_xil (
                .rst        (!reset_),
...
fifo_nx256 #(.DEPTH(dddd), .PTR(pp)) fifo_ddddx256 (     //NOTE: 2**PTR = DEPTH
    .reset_     (),

    .wrclk      (),     //i-1,   Write port clock
    .wren       (),     //i-1,   Write enable
    .wrdata     (),     //i-256, Write data in
