...
// Date: 2022-11-08
// Project: N/A
// Comments: FIFO Wrapper, variable depth, 16-bit wide
//
//********************************
// File history:
//   2022-11-08: Original
...
`ifdef USEIPFIFO
    ...
    generate case((DEPTH > MAX) ? MAX : DEPTH)
        ...
        128: begin
            ...
            fifo_128x16_xil fifo_128x16_xil (
                .rst        (!reset_),
        ...
        256: begin
            ...
            fifo_256x16_xil fifo_256x16_xil (
                .rst        (!reset_),
        ...
        512: begin
            ...
            fifo_512x16_xil fifo_512x16_xil (
                .rst        (!reset_),
        ...
        1024: begin
            ...
            fifo_1024x16_xil fifo_1024x16_xil (
                .rst        (!reset_),
...
fifo_nx16 #(.DEPTH(dddd), .PTR(pp)) fifo_ddddx16 (     //NOTE: 2**PTR = DEPTH
    .reset_     (),

    .wrclk      (),     //i-1,   Write port clock
    .wren       (),     //i-1,   Write enable
    .wrdata     (),     //i-16,  Write data in
